// cloudeflare script //
// Callback function when Turnstile verification is successful
        function onSuccess(token) {
            ...
            setTimeout(function() {
                ...
                setTimeout(function() {
                    ...
                    document.getElementById('websiteContent').scrollIntoView({ 
                        behavior: 'smooth' 
                    });
                }, 1000);
            }, 1500);
        ...
        function exploreMore() {
            alert('Welcome! You can now explore all our premium content.');
        }
        
        // Optional: Add a timeout to show a message if verification takes too long
        setTimeout(function() {
